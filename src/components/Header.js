...
export const Header = () => {
  ...
  return (
    <header>
      <nav className="bg-white border-b-2 border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-900 dark:border-b-2 dark:border-gray-600">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <Link to="/" className="flex items-center">
            <img
              src={Logo}
              className="mr-3 h-6 sm:h-9"
              alt="Alejandra Mantiñan Logo"
            />
          </Link>
